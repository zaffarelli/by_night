# Generated by Django 3.2 on 2021-05-16 18:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('collector', '0002_auto_20210514_0938'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animalism', models.IntegerField(blank=True, db_column='Animalism', null=True)),
                ('auspex', models.IntegerField(blank=True, db_column='Auspex', null=True)),
                ('celerity', models.IntegerField(blank=True, db_column='Celerity', null=True)),
                ('chimerstry', models.IntegerField(blank=True, db_column='Chimerstry', null=True)),
                ('daimoinon', models.IntegerField(blank=True, db_column='Daimoinon', null=True)),
                ('dementation', models.IntegerField(blank=True, db_column='Dementation', null=True)),
                ('dominate', models.IntegerField(blank=True, db_column='Dominate', null=True)),
                ('fortitude', models.IntegerField(blank=True, db_column='Fortitude', null=True)),
                ('melpominee', models.IntegerField(blank=True, db_column='Melpominee', null=True)),
                ('mytherceria', models.IntegerField(blank=True, db_column='Mytherceria', null=True)),
                ('necromancy', models.IntegerField(blank=True, db_column='Necromancy', null=True)),
                ('obeah', models.IntegerField(blank=True, db_column='Obeah', null=True)),
                ('obfuscate', models.IntegerField(blank=True, db_column='Obfuscate', null=True)),
                ('obtenebration', models.IntegerField(blank=True, db_column='Obtenebration', null=True)),
                ('potence', models.IntegerField(blank=True, db_column='Potence', null=True)),
                ('presence', models.IntegerField(blank=True, db_column='Presence', null=True)),
                ('protean', models.IntegerField(blank=True, db_column='Protean', null=True)),
                ('quietus', models.IntegerField(blank=True, db_column='Quietus', null=True)),
                ('sanguinus', models.IntegerField(blank=True, db_column='Sanguinus', null=True)),
                ('serpentis', models.IntegerField(blank=True, db_column='Serpentis', null=True)),
                ('temporis', models.IntegerField(blank=True, db_column='Temporis', null=True)),
                ('thanatosis', models.IntegerField(blank=True, db_column='Thanatosis', null=True)),
                ('thaumaturgy', models.IntegerField(blank=True, db_column='Thaumaturgy', null=True)),
                ('valeren', models.IntegerField(blank=True, db_column='Valeren', null=True)),
                ('vicissitude', models.IntegerField(blank=True, db_column='Vicissitude', null=True)),
                ('visceratika', models.IntegerField(blank=True, db_column='Visceratika', null=True)),
